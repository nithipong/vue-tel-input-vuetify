	...
	*/
	...
	var script = {
	  ...
	  mounted: function mounted() {
	    ...
	    this.$watch('$refs.countryInput.isResetting', function (v) {
	      return v && _this3.reset();
	    });
	    this.reset();
	  },
	  ...
	  methods: {
	    ...
	    reset: function reset() {
	      ...
	      this.initializeCountry().then(function () {
	        if (!_this7.phone && _this7.inputOptions && _this7.inputOptions.showDialCode && _this7.activeCountry.dialCode) {
	          _this7.phone = "+".concat(_this7.activeCountry.dialCode);
	        }

	        _this7.countryCode = _this7.activeCountry;

	        _this7.$emit('validate', _this7.phoneObject);

	        _this7.$emit('onValidate', _this7.phoneObject); // Deprecated

	      }).catch(console.error).finally(function () {
	        _this7.finishMounted = true;
	      });
	      this.open = false;
	    },
	  ...
	  return _c("div", {
	    ...
	    scopedSlots: _vm._u([{
	      ...
	      fn: function fn() {
	        ...
	        }), _vm._v(" "), _c("span", [_vm._v(_vm._s("+" + _vm.activeCountry.dialCode))])];
	      },
	      proxy: true
	    }, {
	      key: "item",
	...
	var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
	  ...
	  inject("data-v-6452088e_0", {
	    ...
	    map: {
	      "version": 3,
	      "sources": ["/Users/nithipong/Sites/vue-tel-input-vuetify/src/lib/vue-tel-input-vuetify.vue", "vue-tel-input-vuetify.vue"],
	      "names": [],
	      "mappings": "AAwxBA;EACA,iBAAA;ACvxBA;AD0xBA;EACA,aAAA;EACA,mBAAA;ACvxBA;ADyxBA;EACA,WAAA;ACvxBA;AD0xBA;EACA,gCAAA;ACxxBA;AD4xBA;EACA,kBAAA;AC1xBA;AD2xBA;EACA,kBAAA;EACA,iBAAA;ACzxBA;AD8xBA;EACA,iBAAA;AC5xBA;;AAEA,oDAAoD",
